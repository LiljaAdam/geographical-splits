...
if __name__ == "__main__":
    ...
    parser.add_argument("--og_pkl_name",type=str, help="Name of the original pickle files", default="nuscenes_map_infos_temporal")
    ...
    if not os.path.exists(split_pkl_file):
        split_pkl_file = "geo_splits/nusc_geo.pkl"
    ...
    elif method == "vectormapnet" or method == "hdmapnet" or method == "mars":
        train, val, test = convert_mars(pkl_dir, token_to_set, og_pkl_name)
    else:
